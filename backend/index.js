...
mongoose.connect(
  "mongodb+srv://ecommercedb:Bv37L4XT8VLfyK@cluster0.4qzxqbw.mongodb.net/e-commerce"
);
...
app.post("/login", async (req, res) => {
  ...
  if (user) {
    ...
    res.json({ success: false, errors: "Email ID is not registered" });
  }
});
...
// creating middleware to fetch current user
...
//creating endpoint to save cart products in db
...
// creating endpoint to remove cart data in db
